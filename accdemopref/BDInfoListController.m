...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        if (@available(iOS 8.0, *)) {
            ...
            [spec setProperty:[UIImage imageNamed:@"twitter"
        ...
        if (@available(iOS 8.0, *)) {
            [spec setProperty:@YES forKey:@"hasIcon"];
            [spec setProperty:[UIImage imageNamed:@"paypal"
                                         inBundle:[NSBundle bundleForClass:[self class]]
                    compatibleWithTraitCollection:nil]
                       forKey:@"iconImage"];
        }
        ...
        if (@available(iOS 8.0, *)) {
            [spec setProperty:@YES forKey:@"hasIcon"];
            [spec setProperty:[UIImage imageNamed:@"github"
                                         inBundle:[NSBundle bundleForClass:[self class]]
                    compatibleWithTraitCollection:nil]
                       forKey:@"iconImage"];
        }
        ...
        spec = [PSSpecifier preferenceSpecifierNamed:[[NSBundle bundleForClass:[self class]] localizedStringForKey:@"ADD_MY_REPO"
                                                                                                             value:@"Add my repo"
                                                                                                             table:@"Root"]
                                              target:self
                                                 set:NULL
        ...
        if (@available(iOS 8.0, *)) {
            [spec setProperty:@YES forKey:@"hasIcon"];
            [spec setProperty:[UIImage imageNamed:@"cydia"
                                         inBundle:[NSBundle bundleForClass:[self class]]
                    compatibleWithTraitCollection:nil]
                       forKey:@"iconImage"];
        }
        ...
        if (@available(iOS 8.0, *)) {
            [spec setProperty:@YES forKey:@"hasIcon"];
            [spec setProperty:[UIImage imageNamed:@"alipay"
                                         inBundle:[NSBundle bundleForClass:[self class]]
                    compatibleWithTraitCollection:nil]
                       forKey:@"iconImage"];
        }
        ...
        if (@available(iOS 8.0, *)) {
            [spec setProperty:@YES forKey:@"hasIcon"];
            [spec setProperty:[UIImage imageNamed:@"bilibili"
                                         inBundle:[NSBundle bundleForClass:[self class]]
                    compatibleWithTraitCollection:nil]
                       forKey:@"iconImage"];
        }
...
- (void)open_cydia {
    if ([UIApp canOpenURL:[NSURL URLWithString:@"cydia://url/https://cydia.saurik.com/api/"
                           @"share#?source=http://brendonjkding.github.io"]]) {
        [UIApp openURL:[NSURL URLWithString:@"cydia://url/https://cydia.saurik.com/api/"
                        @"share#?source=http://brendonjkding.github.io"]];
    } else {
...
- (void)open_twitter {
    ...
    } else if ([UIApp canOpenURL:[NSURL URLWithString:@"tweetbot:///user_profile/"
                                  @"brendonjkding"]]) {
